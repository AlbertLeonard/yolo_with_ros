...
#function: 1,receive Image_form info from a ros_topic and detect the picture
#          1,NOT overwrite the origin picture  
#          2,print and pub pose_info BEFORE showing the display_window
...
def showPicResult(image):
	...
	#cv2.putText(display_image, "FPS: ", (10, 20), font_face, font_scale, cv.RGB(255, 255, 0))
	#putText
	x3 = int(x1+5)
	y3 = int(y1-10)
	...
	#If you don't want to save out_img /just want to dispaly the final_pic, 
	#Then just don't use this loop, list all the object_'num'; 
	#but you don't know how many is the 'num'.
...
def callback(data):
	...
	#print '#-----------------------------------#'
		...
		# Typically this should be False if the full image is captured 
		# (ROI not used), and True if a subwindow is captured (ROI used).
...
def yoloDetect():
    ...
    global out_img
    out_img = "/home/lyk/catkin_ws/src/beginner_tutorials/data/test_result.jpg"
    global video_tmp
    video_tmp = "/home/lyk/catkin_ws/src/beginner_tutorials/data/video_tmp.jpg"
